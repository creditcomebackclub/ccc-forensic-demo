...
assert.match(campaign, /cccAccountTrackSnapshots:\s*currentState\.snapshots/);
assert.match(campaign, /disputeAutomaticValuesSnapshot:\s*automaticValuesSnapshot/);
assert.match(campaign, /buildRoundReasonSnapshots/);
assert.match(campaign, /validateRoundReasonSnapshots/);
