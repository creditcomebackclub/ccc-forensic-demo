...
// ---------------------------------------------------------------------------
// Phase 2 (furnisher response analysis) runs SERVER-SIDE
// (netlify/functions/phase2-analyze-background.mjs) for the same reason
// audits do — no Anthropic key stored or used client-side. See
// src/utils/phase2Jobs.js for the client half.
// ---------------------------------------------------------------------------
