...
export const CCC_SOP_CONTROL = Object.freeze({
  ...
  changeSummary: Object.freeze([
    ...
    'Set active pricing to Standard at $99/month, VIP at $179/month, and Paid In Full at $849 for six months of VIP while preserving historical agreement and ledger snapshots.',
  ]),
});
  ...
  Object.freeze({
    ...
    blocks: Object.freeze([
      steps('Owner starts onboarding', [
        'Open the client billing setup and confirm the selected plan: Standard at $99 per month, VIP at $179 per month, or Paid In Full at $849 for six months of VIP. The active plans do not use a First Work Fee.',
      ...
      callout('gold', 'Opening invoice rule', 'For a new Standard or VIP agreement, the owner-created opening invoice is the first monthly payment only. For a new Paid In Full agreement, it is the $849 six-month VIP service price. Creating the invoice never charges a card automatically. Historical signed agreements and ledger entries keep their original terms.'),
