  ...
  return (
    <div>
      ...
      <Note>
        ...
        <br/><br/>
        <strong>Token Optimization (API Level):</strong> CSS formatting is no longer generated by the AI. To guarantee the model never truncates complex forensic arguments by hitting output token limits, all structural CSS is strictly injected server-side after generation. The AI focuses 100% of its tokens on the legal arguments.
      </Note>
    </div>
  );
}
